...
const Navbar = () => {
  return (
    <div>
    <div className='bg-slate-700 text-slate-100 font-semibold text-xl  h-20 p-5 align-middle text-center sticky'>
       <ul className='flex relative justify-around text-center '>
    <h1 className='relative align-middle w-1/6'>LOGO HERE</h1>
