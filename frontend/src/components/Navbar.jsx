...
const Navbar = () => {
  const  docToken = (localStorage.getItem('doctorLogin'));
      ...
      <div className="bg-slate-700 text-slate-100 font-semibold text-xl h-18 p-5 align-middle text-center sticky">
        <ul className="flex relative justify-around text-center">
          ...
          <li className="flex relative justify-between ">
            <CiSearch className="text-white h-8 w-7 mr-3 border-lime-200" />
            <input
              placeholder="  search"
              className="text-black w-72 h-9 border rounded "
              type="search"
            />
          </li>
          ...
          {docToken === false ? <>
            ...
            <NavLink to="/docLogin">Doctor Registration</NavLink>
            <li>
