    ...
    <>
      ...
      >
        <div className="w-1/3 md:w-1/4 p-4 bg-white rounded-lg shadow-lg ">
          <label className="block mb-2 text-sm font-bold text-gray-500 dark:text-white">
            Name:
          </label>
          <input
            type="text"
            onChange={(e) => setName(e.target.value)}
            className="w-full px-3 py-2 text-sm leading-tight text-gray-500 dark:text-white border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
            placeholder="Name"
            required
          />
          <label className="block mb-2 text-sm font-bold text-gray-500 dark:text-white">
        ...
        <div className="w-full md:w-1/4 p-4 bg-white rounded-lg shadow-lg ">
          ...
          <h3 className="mb-2 mt-2 font-semibold text-gray-900 dark:text-white">
            Gender :
          </h3>
